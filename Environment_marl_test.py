...
class Environ:
    ...
    def Compute_Performance_Reward_Train(self, actions_power):
        ...
        V2I_Interference = np.zeros(self.n_RB)
        for i in range(len(self.vehicles)):
            for j in range(self.n_neighbor):
    ...
    def Compute_Performance_Reward_Test_sarl(self, actions_power):
        ...
        self.active_links_sarl[np.multiply(self.active_links_sarl, self.demand_sarl <= 0)] = 0
    ...
    def Compute_Performance_Reward_Test_dpra(self, actions_power):
        ...
        self.active_links_dpra[np.multiply(self.active_links_dpra, self.demand_dpra <= 0)] = 0
